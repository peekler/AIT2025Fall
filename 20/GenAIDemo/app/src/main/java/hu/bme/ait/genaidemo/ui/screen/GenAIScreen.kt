package hu.bme.ait.genaidemo.ui.screen
...
fun GenAIScreen(
    ...
    var textPrompt by rememberSaveable { mutableStateOf("Magyarul foglald össze a BME Mobil- és webes szoftverek tárgy tartalmát") }
